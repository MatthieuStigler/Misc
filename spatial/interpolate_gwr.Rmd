...
author: "Matthieu"
date: "July 16, 2018"
output: md_document #md_document
---
...
* `spgwr` versus `gstat`: why are `gwr()` and `gstat()` not giving identical results, Inifinite or restricted bandwidth ? **partial answer**: distances in `spgwr` are already squared, so to use idw at power 2 needs just: `1/d`
